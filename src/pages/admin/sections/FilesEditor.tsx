...
const UPLOAD_TARGETS: UploadItem[] = [
  ...
  },
  {
    ...
    description: "Archivo PDF, DOCX, JPG o PNG. Accesible en /recursos/CV_ES.pdf",
    repoPath: "public/recursos/CV_ES.pdf",
    accept: "application/pdf,.pdf,image/jpeg,image/png,.jpg,.jpeg,.png,application/vnd.openxmlformats-officedocument.wordprocessingml.document,.docx",
  ...
  },
  {
    ...
    description: "Archivo PDF, DOCX, JPG o PNG. Accesible en /recursos/CV_EN.pdf",
  ...
  },
  {
    ...
    description: "Archivo PDF, DOCX, JPG o PNG del certificado. Se vinculará al botón de descarga correspondiente.",
  ...
  },
  {
    ...
    description: "Archivo PDF, DOCX, JPG o PNG del certificado de fundamentos de pruebas.",
  ...
  },
  {
    ...
    description: "Archivo PDF, DOCX, JPG o PNG del certificado de Postman / Newman.",
  ...
  },
  {
    ...
    description: "Archivo PDF, DOCX, JPG o PNG del certificado de gestión de pruebas.",
